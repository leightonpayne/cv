...
\begin{EntriesTable}
  ...
  \textbf{PADLOC}
  \newline
  A CLI tool and web server for identifying phage defence systems in prokaryotic genomes
...
\begin{EntriesTable}
  ...
  \newline
  Supported academic staff in teaching fundamental molecular biology techniques.
  \newline
  \textit{\UOO}
\end{EntriesTable}
